...
final class ThreadsCreatorOfRejstrikAZCommand extends Command
{
    ...
    protected static $defaultName = 'threads_creator:rejstrik_cz';
    protected static $defaultDescription = 'Threads creator of rejstrik_cz parser command';
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        foreach (file('characters.csv', FILE_IGNORE_NEW_LINES) as $combination){
            ...
            $commandline = ['/usr/bin/php', $console, ParseRejstrikCommandAZ::COMMAND_NAME, $combinationOption];
